(ns riemann.atom-index-test
(:use riemann.atom-index
        riemann.index
        riemann.core
        riemann.query
...
(deftest ^:bench indexing-atom-time
