// $ANTLR 3.2 Sep 23, 2009 14:05:07 src/reimann/Query.g 2012-02-13 13:29:14
package reimann;
...
public class QueryParser extends Parser {
    ...
    // $ANTLR start "field"
    // src/reimann/Query.g:71:1: field : ( 'host' | 'service' | 'state' | 'description' | 'metric_f' | 'metric' | 'ttl' | 'time' ) ;
    public final QueryParser.field_return field() throws RecognitionException {
        ...
        try {
            // src/reimann/Query.g:71:7: ( ( 'host' | 'service' | 'state' | 'description' | 'metric_f' | 'metric' | 'ttl' | 'time' ) )
            // src/reimann/Query.g:71:9: ( 'host' | 'service' | 'state' | 'description' | 'metric_f' | 'metric' | 'ttl' | 'time' )
            {
            root_0 = (CommonTree)adaptor.nil();
