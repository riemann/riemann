// $ANTLR 3.2 Sep 23, 2009 14:05:07 src/reimann/Query.g 2012-02-12 11:30:55
package reimann;
...
public class QueryLexer extends Lexer {
    ...
    public final void mT__36() throws RecognitionException {
        try {
            int _type = T__36;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/reimann/Query.g:28:7: ( 'ttl' )
            // src/reimann/Query.g:28:9: 'ttl'
            {
            match("ttl"); 
    ...
    public final void mT__37() throws RecognitionException {
        try {
            int _type = T__37;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/reimann/Query.g:29:7: ( 'time' )
            // src/reimann/Query.g:29:9: 'time'
            {
            match("time"); 
    ...
    public final void mID() throws RecognitionException {
        try {
            int _type = ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/reimann/Query.g:81:5: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
            // src/reimann/Query.g:81:7: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            {
            ...
            // src/reimann/Query.g:81:31: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mINT() throws RecognitionException {
        try {
            int _type = INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/reimann/Query.g:84:5: ( ( '-' )? ( '0' .. '9' )+ )
            // src/reimann/Query.g:84:7: ( '-' )? ( '0' .. '9' )+
            {
            // src/reimann/Query.g:84:7: ( '-' )?
            int alt2=2;
    ...
    public final void mFLOAT() throws RecognitionException {
        try {
            int _type = FLOAT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/reimann/Query.g:88:5: ( ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* )? ( EXPONENT )? )
            // src/reimann/Query.g:88:9: ( '-' )? ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* )? ( EXPONENT )?
            {
            // src/reimann/Query.g:88:9: ( '-' )?
            int alt4=2;
            ...
            switch (alt7) {
                case 1 :
                    // src/reimann/Query.g:88:27: '.' ( '0' .. '9' )*
                    {
                    match('.'); 
                    // src/reimann/Query.g:88:31: ( '0' .. '9' )*
                    loop6:
                    do {
                        int alt6=2;
            ...
            // src/reimann/Query.g:88:45: ( EXPONENT )?
            int alt8=2;
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/reimann/Query.g:91:5: ( ( ' ' | '\\t' | '\\r' | '\\n' ) )
            // src/reimann/Query.g:91:9: ( ' ' | '\\t' | '\\r' | '\\n' )
            {
    ...
    public final void mEXPONENT() throws RecognitionException {
        try {
            // src/reimann/Query.g:99:10: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            // src/reimann/Query.g:99:12: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
            {
    ...
    public final void mString() throws RecognitionException {
        try {
            int _type = String;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // src/reimann/Query.g:101:9: ( '\"' ( EscapeSequence | ~ ( '\\u0000' .. '\\u001f' | '\\\\' | '\\\"' ) )* '\"' )
            // src/reimann/Query.g:104:5: '\"' ( EscapeSequence | ~ ( '\\u0000' .. '\\u001f' | '\\\\' | '\\\"' ) )* '\"'
            {
            match('\"'); 
            // src/reimann/Query.g:104:9: ( EscapeSequence | ~ ( '\\u0000' .. '\\u001f' | '\\\\' | '\\\"' ) )*
            loop11:
            do {
                int alt11=3;
                ...
                switch (alt11) {
            	case 1 :
            	    // src/reimann/Query.g:104:11: EscapeSequence
            	    {
            	    mEscapeSequence(); 
    ...
    public final void mEscapeSequence() throws RecognitionException {
        try {
            // src/reimann/Query.g:108:9: ( '\\\\' ( UnicodeEscape | 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\\\' ) )
            // src/reimann/Query.g:108:13: '\\\\' ( UnicodeEscape | 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\\\' )
            {
            match('\\'); 
            // src/reimann/Query.g:108:18: ( UnicodeEscape | 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\\\' )
            int alt12=8;
            switch ( input.LA(1) ) {
            case 'u':
                {
            ...
            switch (alt12) {
                case 1 :
                    // src/reimann/Query.g:108:19: UnicodeEscape
                    {
                    mUnicodeEscape(); 
    ...
    public final void mUnicodeEscape() throws RecognitionException {
        try {
            // src/reimann/Query.g:112:5: ( 'u' HexDigit HexDigit HexDigit HexDigit )
            // src/reimann/Query.g:112:7: 'u' HexDigit HexDigit HexDigit HexDigit
            {
            match('u'); 
            mHexDigit(); 
            mHexDigit(); 
    ...
    public final void mHexDigit() throws RecognitionException {
        try {
            // src/reimann/Query.g:116:5: ( '0' .. '9' | 'A' .. 'F' | 'a' .. 'f' )
            // src/reimann/Query.g:
            {
    ...
    public void mTokens() throws RecognitionException {
        // src/reimann/Query.g:1:8: ( AND | OR | NOT | APPROXIMATELY | NOT_EQUAL | EQUAL | LESSER | LESSER_EQUAL | GREATER | GREATER_EQUAL | TAGGED | T__24 | T__25 | T__26 | T__27 | T__28 | T__29 | T__30 | T__31 | T__32 | T__33 | T__34 | T__35 | T__36 | T__37 | ID | INT | FLOAT | WS | String )
        int alt13=30;
        ...
        switch (alt13) {
            ...
            case 24 :
                ...
                break;
            case 25 :
                // src/reimann/Query.g:1:178: T__37
                {
                mT__37(); 
            ...
            case 27 :
                ...
                break;
            case 28 :
                // src/reimann/Query.g:1:191: FLOAT
                {
                mFLOAT(); 
            ...
            case 29 :
                ...
                break;
            case 30 :
                // src/reimann/Query.g:1:200: String
                {
                mString(); 
