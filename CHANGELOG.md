...
## [0.3.12](https://github.com/riemann/riemann/tree/0.3.12) (2025-05-26)

[Full Changelog](https://github.com/riemann/riemann/compare/0.3.11...0.3.12)

**Closed issues:**

- Database Support for DaMeng [\#1043](https://github.com/riemann/riemann/issues/1043)
- Update to Clojure 1.11.1 [\#1038](https://github.com/riemann/riemann/issues/1038)

**Merged pull requests:**

- fix\(transport,rabbitmq\): no connection - no instrumentation events [\#1051](https://github.com/riemann/riemann/pull/1051) ([serge-medvedev](https://github.com/serge-medvedev))
- Fix: Closing alerts on Opsgenie fails if alias contains special characters [\#1050](https://github.com/riemann/riemann/pull/1050) ([holograph](https://github.com/holograph))
- Update packaging to produce EL9 packages too [\#1049](https://github.com/riemann/riemann/pull/1049) ([faxm0dem](https://github.com/faxm0dem))
- Bump actions/download-artifact from 3 to 4.1.7 in /.github/workflows [\#1045](https://github.com/riemann/riemann/pull/1045) ([dependabot[bot]](https://github.com/apps/dependabot))
- Integrated clj-kondo and addressed many lint warnings and errors [\#1044](https://github.com/riemann/riemann/pull/1044) ([sanel](https://github.com/sanel))
...
- Fix cut-n-paste error in tagged-any docstring [\#1015](https://github.com/riemann/riemann/pull/1015) ([ghost](https://github.com/ghost))
...
- fix bash get JAVA_VERSION [\#986](https://github.com/riemann/riemann/pull/986) ([x1e](https://github.com/x1e))
...
- Add some type hints [\#211](https://github.com/riemann/riemann/pull/211) ([b20n](https://github.com/b20n))
...
- Use a LinkedBlockingQueue in riemann.pool. [\#180](https://github.com/riemann/riemann/pull/180) ([b20n](https://github.com/b20n))
- Ensure that \(:streams core\) is always a vec. [\#179](https://github.com/riemann/riemann/pull/179) ([b20n](https://github.com/b20n))
...
- Parameterize message framing pipeline. [\#32](https://github.com/riemann/riemann/pull/32) ([b20n](https://github.com/b20n))
...
- Change streams/moving-event-window to use take-last instead of subvec. [\#28](https://github.com/riemann/riemann/pull/28) ([b20n](https://github.com/b20n))
...
- Use a pool of sockets for riemann.graphite. [\#22](https://github.com/riemann/riemann/pull/22) ([b20n](https://github.com/b20n))
- Allow custom message-decoding functions for TCP and UDP servers. [\#21](https://github.com/riemann/riemann/pull/21) ([b20n](https://github.com/b20n))
